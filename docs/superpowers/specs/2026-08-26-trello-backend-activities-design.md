...
> **Status histórico:** este documento registra a organização inicial do
> quadro. O escopo técnico vigente do backend foi ampliado em 30 de agosto de
> 2026 e está em `2026-08-30-live-monitor-backend-design.md`.
